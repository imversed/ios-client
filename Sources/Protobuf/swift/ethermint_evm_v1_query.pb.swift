...
struct Ethermint_Evm_V1_QueryTraceTxRequest {
  ...
  var msg: Ethermint_Evm_V1_MsgEthereumTx {
    get {return _msg ?? Ethermint_Evm_V1_MsgEthereumTx()}
    set {_msg = newValue}
  }
  ...
  var traceConfig: Ethermint_Evm_V1_TraceConfig {
    get {return _traceConfig ?? Ethermint_Evm_V1_TraceConfig()}
  ...
  fileprivate var _msg: Ethermint_Evm_V1_MsgEthereumTx? = nil
  fileprivate var _traceConfig: Ethermint_Evm_V1_TraceConfig? = nil
...
extension Ethermint_Evm_V1_QueryTraceTxRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.predecessors) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.predecessors.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.predecessors, fieldNumber: 4)
    }
