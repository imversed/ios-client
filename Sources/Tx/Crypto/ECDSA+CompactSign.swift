...
extension ECDSA {
    ...
    static func compactsign(_ data: Data, privateKey: Data) throws -> Data {
        ...
        guard compact.withUnsafeMutableBytes({
            return secp256k1_ecdsa_signature_serialize_compact(ctx, $0, normalizedsig)
        }) == 1 else {
            throw HDWalletKitError.noEnoughSpace
        }
