...
class SegwitAddrCoder {
    ...
    func decode(hrp: String? = nil, addr: String) throws -> (version: Int, program: Data) {
    ...
    func encode(hrp: String, version: Int, program: Data) throws -> String {
        ...
        guard (try? decode(addr: result)) != nil else {
            throw CoderError.encodingCheckFailed
        }
        return result
    }

    func encode2(hrp: String, program: Data) throws -> String {
